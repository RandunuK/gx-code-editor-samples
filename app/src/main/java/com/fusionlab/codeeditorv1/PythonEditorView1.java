...
public class PythonEditorView1 extends AppCompatEditText implements View.OnTouchListener {
    @Override
    ...
    public PythonEditorView1(Context context) {
        super(context);
        init(context);
    }

    public PythonEditorView1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
